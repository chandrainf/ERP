...
import selectors from 'modules/pembelian/pembelianSelectors';

class PembelianViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(PembelianViewItem);
