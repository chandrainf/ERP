...
const schema = new FormFilterSchema([fields.karyawan]);

class KaryawanListFilter extends Component {
  componentDidMount() {
            ...
            return (
              <Form onSubmit={form.handleSubmit}>
                <Row gutter={24}>
                  <Col md={24} lg={12}>
                    <InputFormItem
                      name={fields.karyawan.name}
                      label={fields.karyawan.label}
...
export default withRouter(
  connect(select)(KaryawanListFilter),
);
