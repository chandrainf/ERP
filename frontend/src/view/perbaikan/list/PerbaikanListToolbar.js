...
import selectors from 'modules/perbaikan/list/perbaikanListSelectors';
import auditLogSelectors from 'modules/auditLog/auditLogSelectors';
import actions from 'modules/perbaikan/list/perbaikanListActions';
...
class PerbaikanToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=perbaikan">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: perbaikanSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: perbaikanSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(PerbaikanToolbar);
