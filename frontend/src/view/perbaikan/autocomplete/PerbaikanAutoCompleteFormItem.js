...
import PerbaikanFormModal from 'view/perbaikan/form/PerbaikanFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/perbaikan/perbaikanSelectors';

class PerbaikanAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return PerbaikanService.listAutocomplete(value, limit);
  };
