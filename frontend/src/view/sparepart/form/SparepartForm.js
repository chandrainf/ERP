...
import SupplierAutocompleteFormItem from 'view/supplier/autocomplete/SupplierAutoCompleteFormItem';
            ...
            return (
              <Form onSubmit={form.handleSubmit}>
                ...
                <SupplierAutocompleteFormItem
                  name={fields.suppliers.name}
                  label={fields.suppliers.label}
                  required={fields.suppliers.required}
                  form={form}
                  autoFocus
                />
