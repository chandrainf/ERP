import listActions from 'modules/pembelian/list/pembelianListActions';
...
const prefix = 'PEMBELIAN_DESTROY';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await PembelianService.destroyAll([id]);
      ...
      Message.success(
        i18n('entities.pembelian.destroy.success'),
      );
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await PembelianService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.pembelian.destroyAll.success'),
      );
