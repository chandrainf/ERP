...
import exporterFields from 'modules/pembelian/list/pembelianListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'PEMBELIAN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await PembelianService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.pembelian.exporterFileName'),
