...
import GajiFormModal from 'view/gaji/form/GajiFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/gaji/gajiSelectors';

class GajiAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return GajiService.listAutocomplete(value, limit);
  };
...
export default connect(select)(GajiAutocompleteFormItem);
