const id_ID = {
  ...
  entities: {
    ...
    perbaikan: {
      ...
      label: 'Perbaikan',
      menu: 'Perbaikan',
      exporterFileName: 'perbaikan_export',
      list: {
        menu: 'Perbaikan',
        title: 'Perbaikan',
      },
      create: {
        success: 'Perbaikan berhasil disimpan',
      },
      update: {
        success: 'Perbaikan berhasil disimpan',
      },
      destroy: {
        success: 'Perbaikan berhasil dihapus',
      },
      destroyAll: {
        success: 'Perbaikan berhasil dihapus semua',
      },
      edit: {
        title: 'Ubah Perbaikan',
      },
      fields: {
        id: 'Id',
        tanggal: 'Tanggal Perbaikan',
        permintaans: 'Permintaan Perbaikan',
        tindakan: 'Tindakan Perbaikan',
        foto: 'Foto Perbaikan',
        createdAt: 'Dibuat pada',
        updatedAt: 'Diperbaharui pada',
      ...
      view: {
        title: 'Lihat Perbaikan',
      },
      importer: {
        title: 'Impor Perbaikan',
        fileName: 'perbaikan_import_template',
        hint:
          'Kolom File / Gambar harus berupa URL file yang dipisahkan oleh spasi.',
      },
    },
    karyawan: {
      ...
      label: 'Karyawan',
      menu: 'Karyawan',
      exporterFileName: 'karyawan_export',
      list: {
        menu: 'Karyawan',
        title: 'Karyawan',
      },
      ...
      destroyAll: {
        success: 'Karyawan berhasil dihapus semua',
      },
      edit: {
        title: 'Ubah Karyawan',
      },
      ...
      importer: {
        ...
        fileName: 'karyawan_import_template',
        hint:
          'Kolom File / Gambar harus berupa URL file yang dipisahkan oleh spasi.',
      },
    },
    kasMasuk: {
      ...
      label: 'Kas Masuk',
      menu: 'Kas Masuk',
      exporterFileName: 'kasMasuk_export',
      list: {
        menu: 'Kas Masuk',
        title: 'Kas Masuk',
      },
      create: {
        success: 'Kas Masuk berhasil disimpan',
      },
      update: {
        success: 'Kas Masuk berhasil disimpan',
      },
      destroy: {
        success: 'Kas Masuk berhasil dihapus',
      },
      destroyAll: {
        success: 'Kas Masuk berhasil dihapus semua',
      },
      edit: {
      ...
      view: {
        title: 'Lihat Kas Masuk',
      },
      importer: {
        title: 'Impor Kas Masuk',
        fileName: 'kasMasuk_import_template',
        hint:
          'Kolom File / Gambar harus berupa URL file yang dipisahkan oleh spasi.',
      },
    },
    kasKeluar: {
      ...
      label: 'Kas Keluar',
      menu: 'Kas Keluar',
      exporterFileName: 'kasKeluar_export',
      list: {
        menu: 'Kas Keluar',
        title: 'Kas Keluar',
      },
      create: {
        success: 'Kas Keluar berhasil disimpan',
      },
      update: {
        success: 'Kas Keluar berhasil disimpan',
      },
      destroy: {
        success: 'Kas Keluar berhasil dihapus',
      },
      destroyAll: {
        success: 'Kas Keluar berhasil dihapus semua',
      },
      edit: {
      ...
      new: {
        title: 'Kas Keluar Baru',
      },
      view: {
        title: 'Lihat Kas Keluar',
      },
      importer: {
        title: 'Impor Kas Keluar',
        fileName: 'kasKeluar_import_template',
        hint:
          'Kolom File / Gambar harus berupa URL file yang dipisahkan oleh spasi.',
      },
    },
    gaji: {
      ...
      label: 'Gaji',
      menu: 'Gaji',
      exporterFileName: 'gaji_export',
      list: {
        menu: 'Gaji',
        title: 'Gaji',
      },
      create: {
        success: 'Gaji Karyawan berhasil disimpan',
      },
      update: {
        success: 'Gaji Karyawan berhasil disimpan',
      },
      destroy: {
        success: 'Gaji Karyawan berhasil dihapus',
      },
      destroyAll: {
        success: 'Gaji Karyawan berhasil dihapus semua',
      },
      edit: {
      ...
      fields: {
        ...
        karyawans: 'Nama Karyawan',
        proyeks: 'Proyek',
        totalGaji: 'Total Gaji',
        catatan: 'Catatan',
        createdAt: 'Dibuat pada',
        updatedAt: 'Diperbaharui pada',
      },
      new: {
        title: 'Gaji Baru Karyawan',
      },
      view: {
        title: 'Lihat Gaji Karyawan',
      },
      importer: {
        title: 'Impor Gaji Karyawan',
        fileName: 'gaji_import_template',
        hint:
          'Kolom File / Gambar harus berupa URL file yang dipisahkan oleh spasi.',
      },
    },
    pembelian: {
      ...
      label: 'Pembelian',
      menu: 'Pembelian',
      exporterFileName: 'pembelian_export',
      list: {
        menu: 'Pembelian',
        title: 'Pembelian',
      },
      ...
      destroyAll: {
        success: 'Pembelian berhasil dihapus semua',
      },
      edit: {
      ...
      importer: {
        ...
        fileName: 'pembelian_import_template',
        hint:
          'Kolom File / Gambar harus berupa URL file yang dipisahkan oleh spasi.',
      },
    },
