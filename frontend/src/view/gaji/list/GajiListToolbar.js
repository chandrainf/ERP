...
class GajiToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=gaji">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: gajiSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: gajiSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(GajiToolbar);
