...
import exporterFields from 'modules/karyawan/list/karyawanListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'KARYAWAN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await KaryawanService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.karyawan.exporterFileName'),
