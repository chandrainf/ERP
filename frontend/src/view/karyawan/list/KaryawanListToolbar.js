...
class KaryawanToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=karyawan">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: karyawanSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: karyawanSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(KaryawanToolbar);
