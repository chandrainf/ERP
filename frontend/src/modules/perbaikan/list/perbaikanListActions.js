...
import exporterFields from 'modules/perbaikan/list/perbaikanListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'PERBAIKAN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await PerbaikanService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.perbaikan.exporterFileName'),
